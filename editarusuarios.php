...
if(isset($_GET["id"])){
    $usuarios = $Usuarios ->selecionar($_GET["id"]);
}
?>
<!DOCTYPE html>
<html lang="pt-br">
                                    ...
                                    <input type="hidden" name="codigo" value="<?= $usuarios->codigo ?>">
										<div class="me-n7 pe-7">
											<div class="fv-row mb-7">
														...
														<input type="text" class="form-control form-control-solid" placeholder="" name="email" value = "<?= $usuarios -> email ?>" />
													</div>												
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Senha</label>
														<input type="password" class="form-control form-control-solid" placeholder="" name="senha" value = "<?= $usuarios -> senha ?>" />
													</div>												
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Nome</label>
														<input type="text" class="form-control form-control-solid" placeholder="" name="nome" value = "<?= $usuarios -> nome ?>" />
													</div>												
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Cpf</label>
														<input type="text" class="form-control form-control-solid" placeholder="" name="cpf" value = "<?= $usuarios -> cpf ?>" />
													</div>												
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Tipo</label>
														<input type="text" class="form-control form-control-solid" placeholder="" name="tipo" value = "<?= $usuarios -> tipo ?>" />
													</div>																					
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Cidade</label>
														<input type="text" class="form-control form-control-solid" placeholder="" name="cidade" value = "<?= $usuarios -> cidade ?>" />
													</div>																					
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Estado</label>
														<input type="text" class="form-control form-control-solid" placeholder="" name="estado" value = "<?= $usuarios -> estado ?>" />
													</div>																					
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Bairro</label>

														<input type="text" class="form-control form-control-solid" placeholder="" name="bairro" value = "<?= $usuarios -> bairro ?>" />
													</div>																					
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Rua</label>
														<input type="text" class="form-control form-control-solid" placeholder="" name="rua" value = "<?= $usuarios -> rua ?>" />
													</div>																					
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Número</label>
														<input type="text" class="form-control form-control-solid" placeholder="" name="numero" value = "<?= $usuarios -> numero ?>" />
													</div>																					
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Cep</label>
														<input type="text" class="form-control form-control-solid" placeholder="" name="cep" value = "<?= $usuarios -> cep ?>" />
													</div>																
