							...
							<div class="card">
								<div class="card-body p-0">
									<div class="card-px text-center py-20 my-10">
										<h2 class="fs-2x fw-bolder mb-10">Produto</h2>
							...
							<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered mw-650px">
									<div class="modal-content">
										<form class="form" action="cadastrarproduto.php" method="POST" id="kt_modal_add_customer_form" data-kt-redirect="../../demo3/dist/apps/customers/list.html">
											<div class="modal-header" id="kt_modal_add_customer_header">
												<h2 class="fw-bolder">Produtos</h2>
											...
											<div class="modal-body py-10 px-lg-17">
												<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
													...
													<div class="fv-row mb-7">
														...
														<input type="text" class="form-control form-control-solid" placeholder="" name="tamanho" />
													</div>												
													<div class="fv-row mb-7">
														<label class="required fs-6 fw-bold mb-2">Quantidade</label>
														<input type="number" class="form-control form-control-solid" placeholder="" name="quantidade" />
													</div>												
													<div class="fv-row mb-7">
													...
													<div class="fv-row mb-7">
														...
														<input type="text" class="form-control form-control-solid" placeholder="" name="preco" />
													</div>																					
												</div>
											</div>
